...
# Conclusions <br>
Συμπερασματικά, η γλώσσα προγραμματισμού Processing είναι ένα πολύ ενδιαφέρον και δημιουργικό εργαλείο για την ανάπτυξη διαδραστικών εφαρμογών, καθώς και κατά την άποψη μου είναι μία ευχάριστη διαδικασία η ανάπτυξη της συγκρητικά με άλλες γλώσσες προγραμματισμού. Όσον αναφορά τα παραδοτέα, στην αρχή λόγω και πρώτης επαφής μου με την εφαρμογή του processing δυσκολέυτηκα με την εύρεση βιβλιοθηκών και με το άνοιγμα της κάμερας για αυτό και λείπουν αρκετά στιγμιότυπα από την ανφορά μου χωρίς να έχω ιδιαίτερα κάποιο θέμα με τους κώδικες. Ωστόσο, στην πορεία λύθηκαν αρκετά από αυτά τα θέματα και λόγω της εμπειρίας μου πλεόν στο processing τα πάντα αρχίσαν να γίνονται πιο γρήγορα και εύκολα. Μπορώ να πω πως κάθε φορά που έβλεπα να υλοποιήται κάτι ενθουσιαζόμουν και σε αυτό παίζει σημαντικό ρόλο η όλη διάδραση που είχα με αυτό. Το Processing είναι ένα πολύ φιλκό και εξυπηρετικό περιβάλλον αρκεί να δώσεις τον χρόνο που θέλει για να το εξερευνήσεις και να πειραμτιστείς. Τέλος, το κομμάτι του μπόνους με την kinect φαίνεται πολύ ενδιαφέρον παρόλα αυτά δεν βρήκα τον χρόνο για να ασχοληθώ. <br>
